(() => {
  const adventureName = 'Alien - Deep Down';
  const moduleName = 'alien-deep-down';
   ...
   */
  const welcomeJournal = 'Deep Down Welcome';
  /**
   ...
   */
  const additionalJournals = ["Alien Map Markers"];
  /**
   ...
   */
  const additionalMacros = ["Ligth source (token)"];
  /**
   ...
   */
  const additionalModulePacks = ["alien-deep-down","Jack_Sands-alien-rpg-essentials"];
